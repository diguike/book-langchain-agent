...
last_synced: "2026-05-25T02:41:54+08:00"
---
...
模块 04 到此结束。你已经掌握了 Tool 定义、生产实现、跨厂商统一、MCP 生态、安全集成——一个 Agent 需要的所有"动作能力"。下一模块 [05-Agent 架构](../05-agent-architecture/01-create-agent.md) 把 model、tools、memory 组装成完整的 Agent 系统，重点讲 `createAgent` 内部的 LangGraph 循环、middleware、ReAct / Plan-and-Execute 等架构模式。
