...
feishu_url: "https://fivwvysqdz.feishu.cn/wiki/TvanwpK8kipAvmkDUjBcehEynNd"
last_synced: "2026-05-25T02:42:17+08:00"
---
...
[LangGraph 入门](./03-langgraph-intro.md) 里我把 state 一笔带过：`Annotation.Root` 描述字段、reducer 决定合并语义。这一节展开两件事——
...
这是 [Human-in-the-Loop](./09-human-in-the-loop.md) 实现"修改后恢复"的底层机制。
...
下一节 [Plan and Execute](./05-plan-and-execute.md) 用 LangGraph 实现一种"先规划再执行"的 Agent 架构；之后是 [Self-Reflection](./06-self-reflection.md) 的双 Agent 循环。
