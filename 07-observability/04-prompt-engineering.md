...
last_synced: "2026-05-25T02:43:03+08:00"
---
...
4. 跑一遍，看是否修复
5. 用同一组改动跑 dataset evaluator（[评估方法与指标](./03-evaluation.md) 那一套），看是否引入回归
6. 通过则发版
...
模块 07 到这里告一段落。下一模块 [08 生产部署](../08-production/01-api-server.md) 开始把 Agent 包成 API 服务、加流式、加缓存、加安全、推上线。
