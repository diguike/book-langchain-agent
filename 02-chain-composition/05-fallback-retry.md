...
last_synced: "2026-05-25T02:41:14+08:00"
---
...
至此模块 02 - Chain 组合的全部内容讲完了。我已经过了 LCEL 的五大原语：[顺序](./01-runnable-sequence.md)、[并行](./02-runnable-parallel.md)、[条件路由](./03-runnable-branch.md)、[流式](./04-streaming.md)、容错。下一个绕不过去的问题是：[LCEL vs LangGraph 决策指南](./06-lcel-vs-langgraph.md)——什么时候停在 LCEL，什么时候必须上 LangGraph。再之后进入 [03-记忆系统](../03-memory/)，开始处理"有状态"的对话。
